...
package classes.Scenes.NPCs	{
	...
	public class Forgefather extends NPCAwareContent implements SaveableState	{
		...
		public function workshopMainMenu(): void{
			...
			else if (avatarsExplained && !celessScene.isAdult) addButtonDisabled(10, "Become" +
					" Avatar", "You need to find a being of divine purity or corruption.")
			else if (avatarsExplained && celessScene.isAdult) addButton(10, "Become the Avatar", gargoyleFinalForm).hint("Take the final step.")
